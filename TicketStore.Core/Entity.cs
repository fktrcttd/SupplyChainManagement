...
namespace TicketStore.Core
{
    ...
    public class Entity : IEntityEvent, ICloneable
    {
        ...
        public virtual void Added(DataContext context)
        {
            
        }

        public virtual void Adding(DataContext context)
        {
            LastModifed = DateTime.Now;
        }

        public virtual void Deleting(DataContext context)
        {

        }

        public virtual void Deleted(DataContext context)
        {

        }

        public virtual void Updating(DataContext context)
        {
            LastModifed = DateTime.Now;
        }

        public virtual void Updated(DataContext context)
        {
