...
namespace SCM.DataService.DataContext
{
        ...
        ApplicationUserClaim>
    {
        ...
        public IDbSet<SampleCategory> SampleCategories
        {
            get
            {
                EnsureThreadSafety();
                return Set<SampleCategory>();
            }
        }
        ...
        public IDbSet<CompositionsElement> CompositionsElements
        {
            get
            {
                EnsureThreadSafety();
                return Set<CompositionsElement>();
            }
        }
        ...
        public IDbSet<OrdersSample> OrdersSamples
        {
            get
            {
                EnsureThreadSafety();
                return Set<OrdersSample>();
            }
        }
        #endregion
